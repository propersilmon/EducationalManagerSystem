            ...
            <div class="card" style="position: absolute; top: 0px;width: 100%">
                ...
                <div class="table-responsive">
                    <table id="data-table-selection" class="table table-striped" >
                        <thead>
                        <tr align="center">
                            <th data-column-id="sender" width="20%" style="text-align: center;">课程号</th>
                        ...
                        <tbody align="center">
                        <c:forEach items="${YXXXCourse}" var="course">
                            <tr>
                                <td>${course.cId}</td>
                                <td>${course.cName}</td>
                    ...
                    <center>
                    <a class="btn btn-success btn-sm" href="<%=basePath%>student/updateBXCourse"> 全部添加</a>
                </center>
                </div>
            </div>
        </div>
