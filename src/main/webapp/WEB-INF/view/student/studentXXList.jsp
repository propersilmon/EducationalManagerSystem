...
<section id="main">
    ...
    <section id="content">
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/student/addXXCourse" method="post">
                <div class="card" style="position: absolute; top: 0px;width: 100%">
                    ...
                    <div class="table-responsive">
                        <table id="data-table-selection" class="table table-striped" >
                            <thead>
                            <tr align="center">
                                <th data-column-id="sender" width="20%" style="text-align: center;">选择</th>
                                <th data-column-id="received" data-order="desc" width="10%" style="text-align: center;">课程号</th>
                                <th data-column-id="received" data-order="desc" width="10%" style="text-align: center;">课程名</th>
                                <th data-column-id="received" data-order="desc" width="10%" style="text-align: center;">学分</th>
                            ...
                            <c:forEach items="${list }" var="course">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="selectCourse" value="${course.cId }">
                                    </td>
                                    <td>${course.cId }</td>
                                    <td>${course.cName }</td>
                        ...
                        <center>
                        <button type="submit" style="color: blue">添加</button>
                        </center>
            </form>
            <center>
