                                            ...
                                            <c:forEach  items="${studentList}" var="student">
                                                <c:if test="${studentCourses.sId==student.sId}">
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <a href="<%=basePath%>teacherController/selectByID?s_id=${student.sId}&c_id=${course.cId}" class="btn btn-info waves-effect" name=""><trans oldtip="Submit" newtip="录入成绩" style="">录入成绩</trans></a>
                                                        </th>
                                                    </tr>
                                                </c:if>
                                            </c:forEach>
