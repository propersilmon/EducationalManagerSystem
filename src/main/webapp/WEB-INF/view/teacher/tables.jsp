            ...
            <aside id="sidebar" class="sidebar c-overflow">
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu active toggled">
                        ...
                        <ul>
                            <li><a class="active" href="tables.jsp">Normal Tables</a></li>
        ...
        <tr>
            <td colspan="8"><div class="pagelist">
                第${pb.pc }页/共${pb.tp }页 <a
                    href="<c:url value='/teacherController/selectCourseController?method=selectPage&pc=1'/>">首页</a>
                <c:if test="${pb.pc>1 }">
                    <a
                            href="<c:url value='/userController?method=selectPage&pc=${pb.pc-1 }'/>">上一页</a>
                </c:if>
                    ...
                    <c:choose>
                        <c:when test="${i eq pb.pc}">
                            <a style="color: green; font-weight: bold; font-size: 16px;"
                               href="<c:url value='/userController?method=selectPage&pc=${i }'/>">${i }</a>
                        </c:when>
                        <c:otherwise>
                            <a
                                    href="<c:url value='/userController?method=selectPage&pc=${i }'/>">${i }</a>
                ...
                <c:if test="${pb.pc<pb.tp }">
                    <a
                            href="<c:url value='/userController?method=selectPage&pc=${pb.pc+1 }'/>">下一页</a>
                </c:if>

                <a
                        href="<c:url value='/userController?method=selectPage&pc=${pb.tp }'/>">尾页</a>
